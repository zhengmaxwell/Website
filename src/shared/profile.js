export const PROFILE = 
{
    description: 'I am a young man who to my parents dismay has not chosen to become a medical doctor. Instead, I aspire to make an impact \
                    ...
                    to make something more \"human-like"\ which has left me with the question: <em>What makes us human?</em> In a world so connected yet so divided at the same time it is easy to lose sight of our humanity. \
